        ...
        <>
            ...
            <Dialog open={maintenanceModalOpen} onOpenChange={setMaintenanceModalOpen}>
                ...
                <DialogContent className="sm:max-w-lg">
                    <MaintenanceModal leaseData={leaseData} currentBill={currentBill} tenantID={tenantID}
                                      setMaintenanceModalOpen={setMaintenanceModalOpen} unitID={unitID} />
                </DialogContent>
            </Dialog>
        </>
    );
    ...
    return (
        <>
            ...
            <div className="space-y-4">
                ...
                <div className="space-y-2">
                    <InputLabel label="Amount" labelText="Amount"
                                input={<Input id={'Amount'} type="number" className="bg-gray-50"
