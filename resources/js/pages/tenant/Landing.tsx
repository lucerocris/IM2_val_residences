...
const TenantDashboard = ({ tenantData, leaseData, rentalBill, maintenanceRequests, onboardingLease, tenantID, unitID, userInfo, leaseID }: ExtendedTenantDashboardProps) => {
                ...
                <div className="px-12 py-8">
                    ...
                    <div className="grid grid-cols-1 gap-8  lg:grid-cols-3">
                        ...
                        <div className="space-y-6">
                            <ButtonSection leaseData={leaseData[0]} currentBill={rentalBill} tenantID={tenantID} unitID={unitID} leaseID={leaseID}/>
